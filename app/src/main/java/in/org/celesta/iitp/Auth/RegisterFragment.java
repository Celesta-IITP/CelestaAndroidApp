...
public class RegisterFragment extends Fragment {
    ...
    EditText first_name_edittext,last_name_edittext,phone_edittext,email_edittext,college_edittext,password_editttext
            ,confirm_password_edittext,referral_edittext,gender_edittext;
